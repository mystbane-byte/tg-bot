...
FAQ_TEXT = (
    ...
    "👉 (Для лицензии) Ник отображается в лаунчере (справа от кнопки <i>играть</i>).\n"
    ...
    "👉 (Для TLauncher) Ник отображается слева снизу во кладке аккаунтов.\n"
    "Или альтернативный вариант: В профиле сайта TLauncher: https://tlauncher.ru/profile/\n\n"
